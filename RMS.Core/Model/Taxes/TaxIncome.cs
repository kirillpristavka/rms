...
namespace RMS.Core.Model.Taxes
{
    ...
    /// Налог на прибыль.
    /// </summary>
    public class TaxIncome : XPObject, ITax
    {
        public TaxIncome() { }
        public TaxIncome(Session session) : base(session) { }
        ...
        public XPCollection<ChronicleTaxIncome> ChronicleTaxIncome
        {
            get
            {
                return GetCollection<ChronicleTaxIncome>(nameof(ChronicleTaxIncome));
            }
        }

...
{
    /// <summary>
    /// Хроника изменений 1C Бухгалтерия.
    /// </summary>
    public class ChronicleOneEsBookkeeping : XPObject
    {
        public ChronicleOneEsBookkeeping() { }
        public ChronicleOneEsBookkeeping(Session session) : base(session) { }

...
{
    /// <summary>
    /// Хроника изменений земельного налога.
    /// </summary>
    public class ChronicleTaxLand : XPObject, ITaxChronicle
    {
        public ChronicleTaxLand() { }
        public ChronicleTaxLand(Session session) : base(session) { }

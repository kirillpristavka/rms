...
{
    /// <summary>
    /// Хроника изменений косвенных налогов
    /// </summary>
    public class ChronicleTaxIndirect : XPObject, ITaxChronicle
    {
        public ChronicleTaxIndirect() { }
        public ChronicleTaxIndirect(Session session) : base(session) { }

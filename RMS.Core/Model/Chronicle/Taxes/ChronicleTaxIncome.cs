...
{
    /// <summary>
    /// Хроника изменений налога на прибыль.
    /// </summary>
    public class ChronicleTaxIncome : XPObject, ITaxChronicle
    {
        public ChronicleTaxIncome() { }
        public ChronicleTaxIncome(Session session) : base(session) { }
